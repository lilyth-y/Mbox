...
(function initWeddingSimpleFan(global) {
  ...
  function getCubeEntryRotation(step) {
    return step === 0 ? CORNER_REST.clone() : getFaceRotation(getPresentationFace(step));
  }

  function getCubeExitRotation(step, presentationCount) {
    return step + 1 >= presentationCount ? CORNER_REST.clone() : getFaceRotation(getPresentationFace(step + 1));
  }
